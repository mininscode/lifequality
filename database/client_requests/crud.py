...
def get_client_requests_by_address(db: Session, address: str, \
                                   skip: int = 0, limit: int = 100):
...
def update_client_request_text(db: Session, request: schemas.ClientRequest, \
                               new_text: str):
...
def update_client_request_citizen_id(db: Session, \
...
def update_client_request_address(db: Session, \
                                  request: schemas.ClientRequest, \
                                  address: str):
...
def update_client_request_source(db: Session, \
                                 request: schemas.ClientRequest, source: int):
    request.request_source = source
    db.commit()
    db.refresh(request)
    return request

def update_client_request_create_date(db: Session, \
                                      request: schemas.ClientRequest, \
                                      created_at: datetime):
...
def update_client_request_update_date(db: Session, \
                                      request: schemas.ClientRequest, \
                                      updated_at: datetime):
...
def update_client_request_close_date(db: Session, \
                                     request: schemas.ClientRequest, \
                                     closed_at: datetime):
...
def update_client_request_fact_duration(db: Session, \
                                        request: schemas.ClientRequest, \
                                        fact_duration: datetime):
    request.fact_duration = fact_duration
    db.commit()
    db.refresh(request)
    return request

def update_client_request_status(db: Session, \
                                 request: schemas.ClientRequest, status: int):
    request.request_status = status
    db.commit()
    db.refresh(request)
    return request

def update_client_request_citizen_feedback(db: Session, \
                                           request: schemas.ClientRequest, \
                                           citizen_feedback: str):
    request.citizen_feedback = citizen_feedback
    db.commit()
    db.refresh(request)
    return request

def update_client_request_activity_status(db: Session, \
                                          request: schemas.ClientRequest, \
                                          is_active: bool):
...
def update_client_request_call_record(db: Session, \
                                      request: schemas.ClientRequest, \
                                      record_id: int):
